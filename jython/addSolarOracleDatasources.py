...
def buildOracleDatasource( abIdent, serverName, portNum, dataBase):
   ...
   jdbcId = AdminConfig.getid('/Cell:psm-cell/ServerCluster:solar-cluster-' + abIdent + '/JDBCProvider:Oracle JDBC Driver/')
 
   print ""
   print "buildOracleDatasource: create SolarDSV5 Datasource for solar-cluster-" + abIdent
