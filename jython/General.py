...
ds =  AdminConfig.getid('/Cell:psm-cell/ServerCluster:jservices-cluster-a/JDBCProvider:Oracle JDBC Driver (XA)/DataSource:Orca Datasource/') 

cf = AdminConfig.getid('/Cell:psm-cell/ServerCluster:jservices-cluster-a/JMSProvider:Default messaging provider/MQQueueConnectionFactory:jsbus-qcf/') 
   #ds =  AdminConfig.getid('/Cell:psm-cell/ServerCluster:jservices-cluster-a/JDBCProvider:Oracle JDBC Driver (XA)/DataSource:Orca Datasource/') 
