...
def buildOracleJdbcResource(abIdent):
   ...
   AdminTask.createJDBCProvider('[-scope Cluster=solar-cluster-' + abIdent + ' -databaseType Oracle -providerType "Oracle JDBC Driver" -implementationType "Connection pool data source" -name "Oracle JDBC Driver" -description "Oracle JDBC Driver" -classpath ${ORACLE_JDBC_DRIVER_PATH}/ojdbc14.jar -nativePath ]')
