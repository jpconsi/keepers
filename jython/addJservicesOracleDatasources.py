...
def buildOracleDatasources(abIdent, dsUrl):
   ...
   jdbcId = AdminConfig.getid('/Cell:psm-cell/ServerCluster:jservices-cluster-' + abIdent + '/JDBCProvider:Oracle JDBC Driver (XA)/')

   print "" 
   print "buildOracleDatasources: create Orca Datasource"

   newDS = AdminTask.createDatasource(jdbcId, '[-name "Orca Datasource" -jndiName jdbc/orca -dataStoreHelperClassName com.ibm.websphere.rsadapter.Oracle10gDataStoreHelper -componentManagedAuthenticationAlias jservices -containerManagedPersistence false -xaRecoveryAuthAlias flare -configureResourceProperties [[URL java.lang.String ' + dsUrl + ']]]')
